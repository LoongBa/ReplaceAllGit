        ...
        public void ThemeControl(Control control)
        {
            ...
            if (control is ListView lView)
            {
                if (lView.View == View.Details)
                {
                    ...
                    lView.DrawItem += (_, e) => { e.DrawDefault = true; };
                    lView.DrawSubItem += (_, e) =>
                    {
            ...
            {
                link.LinkColor = OScolors.TextActive;
